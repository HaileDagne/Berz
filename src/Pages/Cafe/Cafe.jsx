...
export default function Cafe() {
  ...
  const cafeItems = [
    // Coffee Items
    {
      ...
      category: "coffee",
      description:
        "Traditional Ethiopian coffee ceremony with freshly roasted beans, served with popcorn and traditional bread.",
      price: 85,
      image: "☕",
      popular: true,
      features: [
    ...
    },
    {
      ...
      category: "coffee",
      description:
        "Rich espresso with a dollop of steamed milk foam, perfect balance of bold and creamy.",
      price: 45,
      image: "☕",
      popular: true,
    ...
    },
    {
      ...
      category: "coffee",
      description:
        "Classic Italian cappuccino with equal parts espresso, steamed milk, and foam.",
      price: 50,
      image: "☕",
    ...
    },
    {
      ...
      category: "coffee",
      description:
        "Smooth espresso diluted with hot water for a clean, strong coffee experience.",
      price: 40,
      image: "☕",
    ...
    },
    {
      ...
      category: "coffee",
      description:
        "Rich espresso with steamed milk and a light layer of foam, smooth and creamy.",
      price: 55,
      image: "☕",
    ...
    },
    {
      ...
      category: "coffee",
      description:
        "Smooth cold-brewed coffee served over ice, refreshing and less acidic.",
      price: 45,
      image: "🧊",
    ...
    // Tea & Beverages
    {
      ...
      category: "tea",
      description:
        "Authentic Ethiopian tea blend with herbs and spices, served hot or cold.",
      price: 35,
      image: "🍵",
    ...
    },
    {
      ...
      category: "tea",
      description:
        "Spiced tea with steamed milk, warm and aromatic with traditional spices.",
      price: 45,
      image: "🍵",
    ...
    },
    {
      ...
      category: "tea",
      description:
        "Premium green tea leaves, light and refreshing with antioxidant benefits.",
      price: 30,
      image: "🍵",
    ...
    },
    {
      ...
      category: "tea",
      description:
        "Selection of herbal teas including chamomile, mint, and ginger.",
      price: 35,
      image: "🌿",
    ...
    // Pastries & Snacks
    {
      ...
      category: "pastries",
      description:
        "Buttery, flaky French croissant, perfect with coffee or tea.",
      price: 25,
      image: "🥐",
      popular: true,
    ...
    },
    {
      ...
      category: "pastries",
      description:
        "Fresh baked muffins in various flavors: blueberry, chocolate, and banana.",
      price: 30,
      image: "🧁",
    ...
    },
    {
      ...
      category: "pastries",
      description:
        "Sweet pastry with fruit filling and glaze, light and delicious.",
      price: 35,
      image: "🥖",
    ...
    },
    {
      ...
      category: "pastries",
      description:
        "Fresh bagels with cream cheese, perfect for breakfast or snack.",
      price: 40,
      image: "🥯",
    ...
    // Smoothies
    {
      ...
      category: "smoothies",
      description:
        "Fresh mango blended with yogurt and honey, tropical and refreshing.",
      price: 50,
      image: "🥭",
    ...
    },
    {
      ...
      category: "smoothies",
      description:
        "Classic combination of strawberries and banana with yogurt and honey.",
      price: 45,
      image: "🍓",
    ...
    },
    {
      ...
      category: "smoothies",
      description:
        "Spinach, kale, apple, and ginger for a healthy, energizing drink.",
      price: 55,
      image: "🥬",
    ...
    },
    {
      ...
      category: "smoothies",
      description:
        "Chocolate protein powder with banana and almond milk, perfect post-workout.",
      price: 60,
      image: "🍫",
    ...
    },
    {
      ...
      category: "desserts",
      description:
        "Rich chocolate cake with ganache frosting, moist and decadent.",
      price: 55,
      image: "🍰",
    ...
    },
    {
      ...
      category: "desserts",
      description:
        "Creamy cheesecake with berry compote, light and satisfying.",
      price: 60,
      image: "🧀",
    ...
    },
    {
      ...
      category: "desserts",
      description:
        "Premium ice cream in various flavors: vanilla, chocolate, and strawberry.",
      price: 40,
      image: "🍦",
    ...
    <div className="cafe-page">
      ...
      <div className="cafe-hero">
        <div className="cafe-hero-content">
          <h1 className="cafe-hero-title">Our Cafe</h1>
          <p className="cafe-hero-description">
            Experience our premium cafe offerings featuring authentic Ethiopian
            coffee ceremonies, freshly brewed beverages, delicious pastries, and
            sweet treats. Perfect for relaxing, working, or catching up with
            friends.
          </p>
        ...
        <div className="cafe-items-section">
          <div className="cafe-items-grid">
            {filteredItems.map((item, index) => (
              <div
                key={item.id}
                className={`cafe-item-card ${item.popular ? "popular" : ""}`}
              >
        ...
        <div className="cafe-experience-section">
          ...
          <div className="experience-grid">
            <div className="experience-card">
              ...
              <p>
                Experience our authentic Ethiopian coffee ceremony with freshly
                roasted beans and traditional accompaniments.
              </p>
            </div>
            ...
            <div className="experience-card">
              ...
              <p>
                Relax in our comfortable seating areas perfect for work, study,
            ...
            <div className="experience-card">
              ...
              <h3>Fresh Daily</h3>
              <p>
                All our pastries, smoothies, and desserts are prepared fresh
                daily using premium ingredients.
              </p>
            </div>
          </div>
        </div>
