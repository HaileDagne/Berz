    ...
    setTimeout(() => {
      ...
      const event = new CustomEvent('showNotification', {
        detail: {
          ...
          message: `Your order of ${cart.length} items (${getTotalPrice().toFixed(2)} Birr) has been placed. We'll call you shortly!`
        }
      });
  ...
  return (
    <div className="order-page">
      ...
      <div className="order-hero">
        <div className="order-hero-bg"></div>
        <div className="order-hero-particles">
        ...
        <div className="order-hero-content">
          <h1 className="order-hero-title">
            <span className="title-main">Order Now</span>
            <span className="title-sub">Premium Ethiopian Cuisine</span>
          </h1>
          <p className="order-hero-description">
            Experience authentic Ethiopian flavors delivered fresh to your doorstep. 
            Choose from our premium selection and enjoy a culinary journey like no other.
          </p>
      ...
      <div className="order-content">
        ...
        <div className="order-methods-section">
          ...
          <div className="order-methods-grid">
            <div className={`order-method-card ${orderMethod === 'phone' ? 'active' : ''}`}
            ...
            <div className={`order-method-card ${orderMethod === 'online' ? 'active' : ''}`}
